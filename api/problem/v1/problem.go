...
type ProblemCreateReq struct {
	g.Meta `path:"/" method:"post" tags:"题库" summary:"创建题目"`
	*model.InProblem
}
...
type ProblemUpdateReq struct {
	g.Meta `path:"/{id}" method:"put" tags:"题库" summary:"修改一条题目"`
...
type ProblemGetOneReq struct {
	g.Meta `path:"/{id}" method:"get" tags:"题库" summary:"获取一条题目"`
	Id     string `json:"id" v:"required#无效id|IsNumeric#id不正确|min:1#id不正确"`
}
...
type ProblemGetListReq struct {
	g.Meta `path:"/" method:"get" tags:"题库" summary:"获取题目"`
	*casql.BaseListInput
}
...
type ProblemDeleteReq struct {
	g.Meta `path:"/{id}" method:"delete" tags:"题库" summary:"删除题目"`
	Id     string `json:"id" v:"required#无效id|IsNumeric#id不正确|min:1#id不正确"`
}
